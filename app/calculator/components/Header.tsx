...
export default function Header() {
    ...
    const navLinks = [
        ...
        { href: "/calculator/stock", label: "💰 금융" },
        { href: "/calculator/stock", label: "🏢 부동산" },
        { href: "/calculator/stock", label: "🏠 생활" },
        { href: "/calculator/stock", label: "💪 건강" },
        { href: "/calculator/stock", label: "🧮 기타" },
    ];
