...
export default function InstallBanner() {
    ...
    return (
        <div className="mt-8 max-w-3xl mx-auto w-full bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-2xl p-6 shadow-sm animate-fade-in">
