                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full h-16 px-5 pr-12 text-2xl font-bold bg-gray-50 dark:bg-gray-900/50 border-2 rounded-2xl transition-all outline-none text-right dark:text-white ${
                                    errors.has("monthlyAmount") ? "border-red-500 focus:border-red-500 ring-4 ring-red-500/10" : "border-gray-300 dark:border-gray-600 focus:border-green-500 ring-green-500/10 focus:ring-4"
                                }`}
                            />
                                ...
                                <div className="relative flex-1">
                                    <input
                                        ...
                                        className={`w-full h-14 px-4 pr-12 text-xl font-bold bg-gray-50 dark:bg-gray-900/50 border-2 rounded-2xl transition-all outline-none text-right dark:text-white ${
                                            errors.has("term") ? "border-red-500 focus:border-red-500 ring-4 ring-red-500/10" : "border-gray-300 dark:border-gray-600 focus:border-green-500 ring-green-500/10 focus:ring-4"
                                        }`}
                                    />
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="0.0"
                                    className={`w-full h-14 px-4 pr-12 text-xl font-bold bg-gray-50 dark:bg-gray-900/50 border-2 rounded-2xl transition-all outline-none text-right dark:text-white ${
                                        errors.has("rate") ? "border-red-500 focus:border-red-500 ring-4 ring-red-500/10" : "border-gray-300 dark:border-gray-600 focus:border-green-500 ring-green-500/10 focus:ring-4"
                                    }`}
                                />
