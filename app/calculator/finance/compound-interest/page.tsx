...
export const metadata: Metadata = {
    title: "복리 계산기 | 미래가치, 필요기간, 목표수익률, 월적립액 계산 - JIKO 계산기",
    description: "눈덩이처럼 불어나는 복리의 마법! 적립식 투자 미래가치, 필요기간, 목표수익률, 필요 월 적립액을 계산하고 인플레이션을 반영한 실질 가치까지 확인해보세요.",
    keywords: ["복리 계산기", "적립식 투자", "미래가치 계산", "복리 수익", "투자 수익률", "월복리", "연복리"],
    alternates: { canonical: `${BASE_URL}/calculator/finance/compound-interest` },
    openGraph: {
        title: "복리 계산기 | 미래가치, 필요기간, 목표수익률, 월적립액 계산 - JIKO 계산기",
        description: "눈덩이처럼 불어나는 복리의 마법! 적립식 투자 미래가치, 필요기간, 목표수익률, 필요 월 적립액을 계산하고 인플레이션을 반영한 실질 가치까지 확인해보세요.",
        url: `${BASE_URL}/calculator/finance/compound-interest`,
        images: [{ url: `${BASE_URL}/calculator/jiko-calculator-icon2.png`, width: 1200, height: 630, alt: "복리 계산기" }],
    },
};
...
export default function CompoundInterestPage() {
    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <NavBar title="복리 계산기" description="적립식 투자 미래가치, 필요기간, 목표수익률, 필요 월 적립액을 4-in-1으로 계산하세요." position="top" />
            <CompoundInterest />

            <main className="max-w-3xl mx-auto px-4 pb-16 space-y-4 mt-4">
                <section className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-3 flex items-center gap-2">
                        <span className="text-2xl">📈</span> 복리 계산기 가이드 (Snowball Effect)
                    </h1>
