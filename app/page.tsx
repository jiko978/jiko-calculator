  ...
  return (
    <main className="bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-items-start">
        <div className="flex-grow px-4 py-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-10 text-gray-800 dark:text-gray-100">📈 주식 물타기/불타기 시뮬레이션 계산기</h1>
          <p className="text-3xl md:text-2xl font-bold mb-10 text-center text-gray-800 dark:text-gray-100">필요한 계산기를 선택하세요.</p>
