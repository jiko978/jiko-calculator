...
**2.** [디렉토리 구조]
**3.** [메뉴 구조]
**4.** [상태 및 설정파일 관리](#설정파일-관리)
**5.** [공통 컴포넌트 관리](#공통파일-관리)
**6.** [문서(MD) 기반 개발 원칙(바이브 코딩)](#md파일-관리)
**7.** [디자인 가이드라인](#디자인-패턴)
**8.** [빌드 및 배포]
**9.** [공통 기능]
**10.** [테스트 및 품질 관리] **(신규)**
...
## 메뉴 구조
주식(stock)
ㄴ 평균 단가 : 차수별 평균 단가 계산
ㄴ 수익률 : 매입가, 현재가, 수량별 수익금/수익률 계산

금융(finance)
ㄴ 예금 : 예금이자율, 예금액, 예금기간별 예금이자 계산(네이버 참고)
ㄴ 적금 : 적금이자율, 적금액, 적금기간별 적금이자 계산(네이버 참고)
ㄴ 대출 : 대출이자율, 대출액, 대출기간별 대출이자 계산(네이버 참고)
ㄴ LTV : 네이버 참고                      
ㄴ DTI : 네이버 참고                      
ㄴ DSR : 네이버 참고                      
...
ㄴㄴ 실업급여
ㄴ 마트
ㄴㄴ 온라인/오프라인 상품 비교 : 수량기준 동일 상품 최저가 판단
ㄴ 달력
ㄴ 단위
ㄴㄴ 길이 : 네이버 참고
ㄴㄴ 넓이 : 네이버 참고
...
건강(health)
ㄴ 칼로리 : 걷기, 계단, 등산, 수영, 복싱, 줄넘기, 자전거, 달리기, 런닝머신, 배드민턴, 탁구, 크로스핏 등
